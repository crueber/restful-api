...
module.exports = function (express_app, overriden_defaults) {
  ...
  this.resource = function () {
    var options = {}
    if (typeof arguments[arguments.length - 1] == 'object') options = arguments.pop()
    options.prototype = defaults

    options.controller_path = []
    var base_path = options['prefix']
    var controller = controllers[arguments[arguments.length - 1]]
    ...
    _.each(options.individual_actions, function (i) { 
      attach_to_express(i.http_verb, i.controller_action, base_path_with_id, controller, options) 
    })
